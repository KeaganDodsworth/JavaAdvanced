...
public class Main {
    ...
    public static void main(String[] args) {
        File file = new File("C:\\Users\\fabio\\OneDrive\\Desktop\\Java Advanced\\JavaAdvanced\\SoccerApp\\src\\main\\resources\\results.txt");
        Scanner sc = null;
        ...
        System.out.println("Results: " + reverseSortedMap);
